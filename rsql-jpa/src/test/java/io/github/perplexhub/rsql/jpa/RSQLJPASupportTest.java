...
import io.github.perplexhub.rsql.common.*;
...
import io.github.perplexhub.rsql.common.test.model.account.AddressEntity;
import io.github.perplexhub.rsql.common.test.model.account.AddressHistoryEntity;
import io.github.perplexhub.rsql.common.test.repository.jpa.*;
import io.github.perplexhub.rsql.jpa.custom.CustomType;
import io.github.perplexhub.rsql.jpa.repository.jpa.custom.CustomTypeRepository;
...
class RSQLJPASupportTest {
	...
	final void testFunctionRejected() {
		...
		org.junit.jupiter.api.Assertions.assertThrows(RSQLException.class, () -> companyRepository.findAll(toSpecification), "Blacklisted function should throw exception");
