...
import io.github.perplexhub.rsql.jpa.starter.RSQLJPAAutoConfiguration.HibernateEntityManagerDatabaseConfiguration;
...
public class RSQLJPAAutoConfiguration {
  ...
  public record EntityManagerDatabase(Map<EntityManager, Database> value) {
